...
module.exports = {
    ...
    theme: {
        ...
        colors: {
            ...
            actionPrimaryBackgroundDisabled: 'var(--color-button-primary-bg-disabled)',
            actionPrimaryBackgroundHovered: 'var(--color-button-primary-bg-hovered)',
            ...
            actionPrimaryBorderDisabled: 'var(--color-button-primary-border-disabled)',
            actionPrimaryBorderHovered: 'var(--color-button-primary-border-hovered)',
            ...
            actionSecondaryTextDisabled: 'var(--color-button-secondary-text-disabled)',
            actionSecondaryTextHovered: 'var(--color-button-secondary-text-hovered)',
            actionSecondaryBackground: 'var(--color-button-secondary-bg-default)',
            actionSecondaryBackgroundActive: 'var(--color-button-secondary-bg-active)',
            actionSecondaryBackgroundDisabled: 'var(--color-button-secondary-bg-disabled)',
            actionSecondaryBackgroundHovered: 'var(--color-button-secondary-bg-hovered)',
            actionSecondaryBorder: 'var(--color-button-secondary-border-default)',
            actionSecondaryBorderActive: 'var(--color-button-secondary-border-active)',
            actionSecondaryBorderDisabled: 'var(--color-button-secondary-border-disabled)',
            actionSecondaryBorderHovered: 'var(--color-button-secondary-border-hovered)',

            actionInvertedText: 'var(--color-button-inverted-text-default)',
            actionInvertedTextActive: 'var(--color-button-inverted-text-active)',
            actionInvertedTextDisabled: 'var(--color-button-inverted-text-disabled)',
            ...
            actionInvertedBackgroundActive: 'var(--color-button-inverted-bg-active)',
            actionInvertedBackgroundDisabled: 'var(--color-button-inverted-bg-disabled)',
            actionInvertedBackgroundHovered: 'var(--color-button-inverted-bg-hovered)',
            actionInvertedBorder: 'var(--color-button-inverted-border-default)',
            actionInvertedBorderActive: 'var(--color-button-inverted-border-active)',
            actionInvertedBorderDisabled: 'var(--color-button-inverted-border-disabled)',
            actionInvertedBorderHovered: 'var(--color-button-inverted-border-hovered)',

            actionTransparentText: 'var(--color-button-transparent-text-default)',
            actionTransparentTextActive: 'var(--color-button-transparent-text-active)',
            actionTransparentTextDisabled: 'var(--color-button-transparent-text-disabled)',
            actionTransparentTextHovered: 'var(--color-button-transparent-text-hovered)',
            actionTransparentBackground: 'var(--color-button-transparent-bg-default)',
            actionTransparentBackgroundActive: 'var(--color-button-transparent-bg-active)',
            actionTransparentBackgroundDisabled: 'var(--color-button-transparent-bg-disabled)',
            actionTransparentBackgroundHovered: 'var(--color-button-transparent-bg-hovered)',
            actionTransparentBorder: 'var(--color-button-transparent-border-default)',
            actionTransparentBorderActive: 'var(--color-button-transparent-border-active)',
            actionTransparentBorderDisabled: 'var(--color-button-transparent-border-disabled)',
            actionTransparentBorderHovered: 'var(--color-button-transparent-border-hovered)',
